...
const questions = [
  ...
  {
    question: "What’s your favorite way I show love?",
  ...
  {
    question: "What makes you smile faster when it’s from me?",
  ...
  {
    question: "What’s your favorite us moment?",
    options: ["Laughing together", "Watching together", "Late night talks together"],
  },
  {
    question: "If I surprised you, you’d prefer… (I know your answer already)",
  ...
  {
    question: "When you think about me, you feel…",
        ...
        {!finished ? (
          ...
          >
            <Card className="max-w-md rounded-2xl shadow-xl bg-pink-50">
              <CardContent className="p-6 space-y-4">
                <h2 className="text-2xl font-bold text-center text-pink-700">A Letter For You 💌</h2>
                ...
                <p className="text-center text-pink-500 font-medium">Forever yours 💗</p>
              </CardContent>
            </Card>
          </motion.div>
        )}
